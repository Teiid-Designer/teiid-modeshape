...
import static org.teiid.modeshape.sequencer.vdb.lexicon.TransformLexicon.Namespace.URI;
...
import org.teiid.modeshape.sequencer.vdb.lexicon.TransformLexicon.JcrId;
import org.teiid.modeshape.sequencer.vdb.lexicon.TransformLexicon.ModelId;
import org.teiid.modeshape.sequencer.vdb.model.ReferenceResolver.UnresolvedReference;
import org.teiid.modeshape.sequencer.vdb.xmi.XmiElement;

/**
 * The model object handler for the {@link org.teiid.modeshape.sequencer.vdb.lexicon.TransformLexicon.Namespace#URI transformation}
 * namespace.
 */
public final class TransformationModelObjectHandler extends ModelObjectHandler {

    /**
     * @see org.teiid.modeshape.sequencer.vdb.model.ModelObjectHandler#process(org.teiid.modeshape.sequencer.vdb.xmi.XmiElement,
     *      javax.jcr.Node)
     */
    @Override
