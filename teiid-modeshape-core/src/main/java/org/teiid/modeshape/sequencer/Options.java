...
public class Options {
     ...
     * @see PropertyFilter
     */
    public static final PropertyFilter DEFAULT_PROPERTY_FILTER = new PropertyFilter() {

        public boolean accept(final String propertyName) {
            return !propertyName.startsWith("dv:")
